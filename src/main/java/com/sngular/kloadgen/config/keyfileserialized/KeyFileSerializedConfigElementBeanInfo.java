...
import com.sngular.kloadgen.property.editor.KeySerializerPropertyEditor;
...
public class KeyFileSerializedConfigElementBeanInfo extends BeanInfoSupport {
  ...
  public KeyFileSerializedConfigElementBeanInfo() {
    ...
    createPropertyGroup("key_serialized_load_generator",
                        new String[]{KEY_NAME_STRATEGY, KEY_SERIALIZER_PROPERTY, KEY_SCHEMA_TYPE, KEY_SUBJECT_NAME, KEY_SCHEMA_DEFINITION, KEY_SCHEMA_PROPERTIES});
