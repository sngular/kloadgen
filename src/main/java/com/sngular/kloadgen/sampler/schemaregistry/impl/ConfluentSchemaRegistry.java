...
public class ConfluentSchemaRegistry implements SchemaRegistryManager {
    ...
    public ConfluentSchemaRegistry() {
        ...
        this.propertiesMap.put(SchemaRegistryKeyHelper.SCHEMA_REGISTRY_NAME, SchemaRegistryConstants.SCHEMA_REGISTRY_CONFLUENT);
        this.propertiesMap.put(SchemaRegistryKeyHelper.SCHEMA_REGISTRY_URL_KEY, AbstractKafkaSchemaSerDeConfig.SCHEMA_REGISTRY_URL_CONFIG);
        this.propertiesMap.put(SchemaRegistryConstants.BASIC_AUTH_CREDENTIALS, AbstractKafkaSchemaSerDeConfig.BASIC_AUTH_CREDENTIALS_SOURCE);
        this.propertiesMap.put(SchemaRegistryConstants.USER_INFO_CONFIG, AbstractKafkaSchemaSerDeConfig.USER_INFO_CONFIG);
        this.propertiesMap.put(SchemaRegistryConstants.BEARER_AUTH_CREDENTIALS , AbstractKafkaSchemaSerDeConfig.BEARER_AUTH_CREDENTIALS_SOURCE);
        this.propertiesMap.put(SchemaRegistryConstants.BEARER_AUTH_TOKEN_CONFIG , AbstractKafkaSchemaSerDeConfig.BEARER_AUTH_TOKEN_CONFIG);
    }
