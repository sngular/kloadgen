...
public class ConfluentSchemaRegistry implements SchemaRegistryManager {
  ...
  @Override
  public Object getLatestSchemaMetadata(final String subjectName) {
    try {
  ...
  public Object getSchemaBySubject(final String subjectName) {
  ...
  public Object getSchemaBySubjectAndId(final String subjectName, final Object metadata) {
