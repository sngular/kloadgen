...
public class AvroSchemaProcessor extends SchemaProcessorLib {
        ...
        if (Objects.nonNull(fieldExprMappings) && !fieldExprMappings.isEmpty()) {
            ...
            while (!fieldExpMappingsQueue.isEmpty()) {
                ...
                if (cleanPath.contains("][")) {
                    ...
                    }else if(checkIfObjectArray(cleanPath)){
                        fieldValueMapping = processFieldValueMappingAsObjectArray(fieldExpMappingsQueue, entity, fieldName);
                    }else {
                        throw new KLoadGenException("Wrong configuration Map - Array");
                    }
                } else if (cleanPath.contains(".")) {
    ...
    private FieldValueMapping processFieldValueMappingAsObjectArray(ArrayDeque<FieldValueMapping> fieldExpMappingsQueue, GenericRecord entity, String fieldName){
    ...
    private Object createArray(String fieldName, Integer arraySize, ArrayDeque<FieldValueMapping> fieldExpMappingsQueue) {
        ...
        return generateRandomMapArray(fieldName, fieldValueMapping.getFieldType(), arraySize, fieldValueMapping.getValueLength(), fieldValueMapping.getFieldValuesList());
    }
    ...
    private Object createSimpleTypeMapArray(String fieldName, String fieldType, Integer arraySize, Integer mapSize, List<String> fieldExpMappings) {
        return generateRandomMap(fieldName, fieldType, arraySize, fieldExpMappings);
    }
