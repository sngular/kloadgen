...
public class FileValueSerializedConfigElementBeanInfo extends BeanInfoSupport {
  ...
  public FileValueSerializedConfigElementBeanInfo() {

    super(FileValueSerializedConfigElement.class);
