...
@Setter
@Slf4j
public class JsonSerializedConfigElement extends ConfigTestElement implements TestBean, LoopIterationListener {
  ...
  public void iterationStart(LoopIterationEvent loopIterationEvent) {
    ...
    try {
      if (generator ==  null) {
        generator = new JsonLoadGenerator(jsonDocument, schemaProperties);
      }
