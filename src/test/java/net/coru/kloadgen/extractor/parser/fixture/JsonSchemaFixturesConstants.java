  ...
  public static final Schema MEDIUM_COMPLEX_SCHEMA =
      Schema.builder()
          ...
          .property(ArrayField
              ...
              .isFieldRequired(true)
              .build())
              .requiredFields(asList("_class","_entity", "_metadata","orderId","storeId","type", "status","origin","orderItems", "_metadata.createdAt", "_metadata.createdBy", "_metadata.lastUpdatedAt", "_metadata.lastUpdatedBy", "billing.status", "billing.addressId", "origin.systemType"))
              .definitions(asList(
                  ObjectField
                      .builder()
                      .name("amount")
