...
public class AvroSchemaFixturesConstants {
  ...
  public static final List<FieldValueMapping> ARRAY_OPTIONAL_NULL_FIELDS = asList(
      FieldValueMapping.builder().fieldName("record_array[1].null_field").fieldType("string").valueLength(0).fieldValueList("null").required(false).isAncestorRequired(true).build(),
      FieldValueMapping.builder().fieldName("record_array[1].not_null_field").fieldType("int").valueLength(0).fieldValueList("null").required(false).isAncestorRequired(true).build(),
      FieldValueMapping.builder().fieldName("array_null[1].string_null_field").fieldType("string").valueLength(0).fieldValueList("null").required(false).isAncestorRequired(false).build(),
  ...
  public static final List<FieldValueMapping> MAP_OPTIONAL_NULL_FIELDS = asList(
      ...
      FieldValueMapping.builder().fieldName("record_map[1:].not_null_field").fieldType("int").valueLength(0).fieldValueList("null").required(false).isAncestorRequired(true).build(),
      FieldValueMapping.builder().fieldName("map_null[1:].string_null_field").fieldType("string").valueLength(0).fieldValueList("null").required(false).isAncestorRequired(false).build(),
