...
public class GenericRecordAvroSerializersTest {
  ...
  private static Stream<Arguments> getSerializerAndSchemaToTest() {
    ...
    AvroSerializersTestFixture.SERIALIZER_LIST.forEach(serializer -> {
      ...
      builder.add(Arguments.arguments(serializerArgument, Named.of(testSubentityArrayFile.getName(), testSubentityArrayFile), AvroSerializersTestFixture.TEST_SUBENTITY_ARRAY.getSecond()));
      final File testEmbededAvrosExampleFile = AvroSerializersTestFixture.TEST_EMBEDED_AVROS_EXAMPLE.getFirst();
      builder.add(Arguments.arguments(serializerArgument, Named.of(testEmbededAvrosExampleFile.getName(), testEmbededAvrosExampleFile), AvroSerializersTestFixture.TEST_EMBEDED_AVROS_EXAMPLE.getSecond()));
      ...
      builder.add(
          Arguments.arguments(serializerArgument, Named.of(testNullOnOptionalFieldsFile.getName(), testNullOnOptionalFieldsFile), AvroSerializersTestFixture.TEST_NULL_ON_OPTIONAL_FIELDS.getSecond()));
      ...
      builder.add(Arguments.arguments(serializerArgument, Named.of(testNullOnOptionalFields.getName(), testNullOnOptionalFields), AvroSerializersTestFixture.TEST_NULL_ON_OPTIONAL_FIELDS.getSecond()));
